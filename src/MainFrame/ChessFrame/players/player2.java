...
public class player2 implements Enumeration {
    ...
    public player2() {
        ...
        String path = "src" + fileSeparator + "Icons" + fileSeparator + "Player2Icons" + fileSeparator;
        BC1 = new Castle(path + "br.gif", 1, 1);
        BC2 = new Castle(path + "br.gif", 8, 1);
        BH1 = new Horse(path + "bn.gif", 2, 1);
        BH2 = new Horse(path + "bn.gif", 7, 1);
        BE1 = new Elephent(path + "bb.gif", 3, 1);
        BE2 = new Elephent(path + "bb.gif", 6, 1);
        BQ = new Queen(path + "bq.gif", 4, 1);
        BK = new king(path + "bk.gif", 5, 1);
        int j = 1;
        for (int i = 0; i <= 7; i++, j++) {
            BS[i] = new Solider(path + "bp.gif", j, 2);
        }
    }
    ...
    public void setLocation(Point newP, int i) {
        switch (i) {
            ...
            case 8:
                ...
                break;
            case 9:
                BS[0].undoMove(newP,"black");
                break;
            case 10:
                BS[1].undoMove(newP,"black");
                break;
            case 11:
                BS[2].undoMove(newP,"black");
                break;
            case 12:
                BS[3].undoMove(newP,"black");
                break;
            case 13:
                BS[4].undoMove(newP,"black");
                break;
            case 14:
                BS[5].undoMove(newP,"black");
                break;
            case 15:
                BS[6].undoMove(newP,"black");
                break;
            case 16:
                BS[7].undoMove(newP,"black");
                break;
        }
    }
