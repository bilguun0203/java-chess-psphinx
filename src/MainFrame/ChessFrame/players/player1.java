...
public class player1 {
    ...
    public player1() {
        ...
        String path = "src" + fileSeparator + "Icons" + fileSeparator + "Player1Icons" + fileSeparator;
        WC1 = new Castle(path + "wr.gif", 8, 8);
        WC2 = new Castle(path + "wr.gif", 1, 8);
        WH1 = new Horse(path + "wn.gif", 2, 8);
        WH2 = new Horse(path + "wn.gif", 7, 8);
        WE1 = new Elephent(path + "wb.gif", 3, 8);
        WE2 = new Elephent(path + "wb.gif", 6, 8);
        WQ = new Queen(path + "wq.gif", 4, 8);
        WK = new king(path + "wk.gif", 5, 8);
        int j = 1;
        for (int i = 0; i <= 7; i++, j++) {
            WS[i] = new Solider(path + "wp.gif", j, 7);
        }
    }
    ...
    public void setLocation(Point newP, int i) {
        switch (i) {
            ...
            case 24:
                ...
                break;
            case 25:
                WS[0].undoMove(newP,"white");
                break;
            case 26:
                WS[1].undoMove(newP,"white");
                break;
            case 27:
                WS[2].undoMove(newP,"white");
                break;
            case 28:
                WS[3].undoMove(newP,"white");
                break;
            case 29:
                WS[4].undoMove(newP,"white");
                break;
            case 30:
                WS[5].undoMove(newP,"white");
                break;
            case 31:
                WS[6].undoMove(newP,"white");
                break;
            case 32:
                WS[7].undoMove(newP,"white");
                break;
        }
    }
