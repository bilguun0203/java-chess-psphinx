...
public class NewGameDialoge extends JDialog {
    ...
    public NewGameDialoge(final MainFrame ff) {
        ...
        button1 = new JButton("Эхлэх");
        button2 = new JButton("Цуцлах");

        button1.setSize(90, 24);
        button2.setSize(90, 24);

        button1.setLocation(45, 250);
        button2.setLocation(135, 250);
        ...
        myCom.addItem("Дотоод");
        myCom.addItem("Сүлжээгээр");
    ...
    private final JLabel type_game = new JLabel(" Тоглоомны төрөл: ");
    private final JLabel IP_address = new JLabel(" IP хаяг : ");
    private final JLabel Port_number = new JLabel(" Порт : ");
    private final JTextField ip_text = new JTextField(12);
    private final JTextField port_text = new JTextField(5);
    private final JRadioButton As_server = new JRadioButton("Сервер");
    private final JRadioButton As_client = new JRadioButton("Клиент");
